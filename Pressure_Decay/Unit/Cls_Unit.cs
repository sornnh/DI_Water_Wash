...
using System.Windows.Forms;
    ...
    public class Cls_Unit
    {
        ...
        public Cls_LS_R902 Cls_LSR902 { get; private set; }
        ...
        public Cls_Unit( string assyPN,string Workoder ,string StationID, Cls_ASPcontrol cls_AS, Cls_LS_R902 clsLSR902)
        {
            try
            {
                _AssyPN = assyPN;
                ...
                cls_SequencyTest = new Cls_SequencyTest(cls_AS, clsLSR902);
                Thread testThread = new Thread(funThreadTest);
                testThread.Name = "ThreadTest";
                testThread.IsBackground = true;
                testThread.Start();
                cls_SequencyCommon = new Cls_SequencyCommon(cls_AS);
